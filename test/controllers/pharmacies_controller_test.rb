...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference("Pharmacy.count") do
      post pharmacies_url, params: { pharmacy: { deliver_address: @pharmacy.deliver_address, email: @pharmacy.email, name: @pharmacy.name, password_digest: @pharmacy.password_digest, postcode: @pharmacy.postcode, stock: @pharmacy.stock } }
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { deliver_address: @pharmacy.deliver_address, email: @pharmacy.email, name: @pharmacy.name, password_digest: @pharmacy.password_digest, postcode: @pharmacy.postcode, stock: @pharmacy.stock } }
